...
public class MainWindowViewModel {
	...
	private void initializeEventHandler() {
		...
		// “滤镜”菜单
		{
			...
			{
			    // 去雾
			    view.mntmDehaze.addActionListener(new ActionListener() {
                    
                    @Override
                    public void actionPerformed(ActionEvent e) {
                        mncFilter.dehaze(imageData);
                    }
                });
			    // 折射率
			    view.mntmTranssmian.addActionListener(new ActionListener() {
                    
                    @Override
                    public void actionPerformed(ActionEvent e) {
                        mncFilter.transsmision(imageData);
                    }
                });
			}
		}
